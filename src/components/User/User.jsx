...
import { setUserToDM } from '../../store/slices/userSlice';
import './user.css'
import { Navigate } from 'react-router-dom';
import { setMessages } from '../../store/slices/messageSlice';

function User({ firstName, lastName, img, dispatch, id, getMessages , setIsOpen}) {
    const clickHandler = async (e) => {
        ...
        setIsOpen(true)
        await axios.get(`https://tasty-shift.cyclic.app/api/conversations/with/${id}`, config).then((res) => {
